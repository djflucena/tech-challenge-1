...
class TestComportamentoProducaoService(unittest.TestCase):
    ...
    @patch("src.services.producao_service.ProducaoRaspagem")
    @patch("src.services.producao_service.ProducaoRepository")
    ...
    @patch("src.services.producao_service.ProducaoRaspagem", side_effect=TimeoutRequisicao())
    @patch("src.services.producao_service.ProducaoRepository")
